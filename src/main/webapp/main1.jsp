...
<head>
    ...
    <style type="text/css">
        .bj {
            background: url(${path}/img/1.jpg) no-repeat center;
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        <a href="javascript:$('#divtable').load('${path}/hospitalShow1.jsp')">
                            医护人员查询
                        </a>
                    </div>
                    <div class="panel-body">
                        <a href="javascript:$('#divtable').load('${path}/departmentShow1.jsp')">
                            部门查询
                        </a>
                    </div>
                </div>
